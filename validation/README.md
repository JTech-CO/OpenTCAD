...
This directory contains engine-independent M0 and M1 validation contracts. It contains no solver, authorized fixture, numerical baseline, or golden result.
...
- `manifests/`: gated M0/M1 status and quarantined image references
